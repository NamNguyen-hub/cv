...
docname: "Resume"
fontawesome: yes
address: "335 S. 46th St. Lincoln, NE 68510"
...
# Data Science Skills
**Communication:** presentations, dashboard design, data analysis reports, scientific publications, data visualization

**Programming Languages:** R, Python, SQL, Matlab, C++

**Software Development:** version control, automated testing, continuous integration

**Numerical Methods:** optimization, solving differential equations

**Statistics:** machine learning, data analysis, generalized linear regression, cluster analysis, factor analysis, principal components analysis, cross validation, model selection, generalized additive models, data analytics, Monte Carlo simulation