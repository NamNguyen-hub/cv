...
%%\documentclass[$if(fontsize)$$fontsize$$else$9pt$endif$,$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$$else$letterpaper$endif$,$for(classoption)$$classoption$$sep$,$endfor$]{article}
...
$else$
\usepackage{geometry}
\geometry{left=1.75cm,right=1.75cm,top=2.2cm,bottom=1.75cm}
$endif$
...
%website
$if(www)$\faicon{home} \href{http://$www$}{Website}\hspace{1 mm} $endif$%
%github
