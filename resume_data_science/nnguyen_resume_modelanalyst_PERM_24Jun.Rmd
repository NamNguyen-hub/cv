---
name: Nam Nguyen, PhD
docname: "Updated: June 2024 - Resume"
fontawesome: yes
address: "Chicago, Illinois"
phone: "+1 224 202 5567"
...
\begin{tblr}{width=1\textwidth, colspec={X[0.1,l]X[2,l]X[0.1,l]X[2,l]X[0.1,l]X[2,l]X[0.1,l]X[2.5,l]}}
  $\bullet$ & Econometrics & $\bullet$ & Machine Learning & $\bullet$ & Data Analysis & $\bullet$ & Structural Modeling \\
  $\bullet$ & Quantitative Modeling & $\bullet$ & Forecasting & $\bullet$ & Cross-validation & $\bullet$ & Model Validation \\
\end{tblr}
...
\begin{tblr}{width=1\textwidth, colspec={X[0.1,l]X[2,l]X[6.8,l]}}
  $\bullet$ & Experiece working with financial products: & {\it Performed model validation on retail and commercial products; Developed performance testing for Current Expected Credit Loss (CECL) models for premium finance products} \\
  $\bullet$ & Experience with quantitative modeling in financial industry using financial and economic data: & {\it Validated retail, commercial, and compliance models; Developed quantitative models in R, Matlab, and SAS through training in PhD program} \\
  $\bullet$ & Experience applying model risk management techniques: & {\it Gained this knowledge while performing model validation work} \\
  $\bullet$ & Experience in econometrics and statistics: & {\it Gained through validation work at Wintrust Financial Corporation, independent research, and training in PhD and Master programs} \\
  $\bullet$ & Highly proficient in MS Office application: & {\it Gained through composing documents, writing reports, analyzing data, designing presentations; proficient in Microsoft Word to generate quality validation report using formatting features for advaced layouts in the word documentation processing; Proficient in the Microsoft Excel (Use of Mathematical and solver functions in Excel); Able to prepare quality presentation in Powerpoint} \\
  $\bullet$ & Experience working with changing regulatory environment: & {\it OCC2011-12 Guidance and DFAST/CCAR, etc. Experience with models related to credit risk (Consumer and Commercial), Compliance (BSA/AML), ALLL and regulatory/economic capital}
\end{tblr}
