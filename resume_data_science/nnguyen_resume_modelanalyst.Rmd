...
\begin{tblr}{width=1\textwidth, colspec={X[0.1,l]X[2,l]X[6.8,l]}}
  $\bullet$ & Financial Product Experience: & {\it Model validation on retail and commercial products, Performance testing for Current Expected Credit Loss (CECL) models for premium finance products} \\
  $\bullet$ & Quantitative modeling using financial and economic data: & {\it Validated retail, commercial, and compliance models; Developed quantitative models in R, Matlab, and SAS} \\
  $\bullet$ & Applying model risk management techniques: & {\it Model validation accordingly to SR11-7 Guidance on Model Risk Management} \\
  $\bullet$ & Econometrics and Statistics: & {\it Gained through validation work, independent research, and training in PhD and Master programs} \\
  $\bullet$ & MS Office application: & {\it Gained through composing documents, writing reports, analyzing data, designing presentations; proficient in Microsoft Word to generate quality validation report using formatting features for advaced layouts in the word documentation processing; Proficient in the Microsoft Excel (Use of Mathematical and solver functions in Excel); Able to prepare quality presentation in Powerpoint} \\
